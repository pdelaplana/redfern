...
namespace Redfern.Web.API
{
    ...
    public class NotificationController : ApiController
    {
        ...
        [Route("{user:alpha}")]
        public IList<NotificationItem> Get(string user) 
        {
            return AutoMapper.Mapper.Map<IList<Notification>, IList<NotificationItem>>(_repository.Notifications.Where(n => n.RecipientUser == user && !n.ReadDate.HasValue).ToList());
        }

(function($) {
    ...
    $.Dialog = function(params) {
        ...
        if (params.element != '' && params.element != undefined)
            _content = $(params.element).show().addClass('content');
        else 
        ...
        _overlay.hide().appendTo(params.container)//;.fadeIn('fast');
        ...
        if(params.draggable) {
            _caption.on("mousedown", function(e) {
                ...
                _window.css('z-index', 900).parents().on("mousemove", function(e) {
        ...
        _dialog.open = $.Dialog.open;
        _dialog.close = $.Dialog.close;
        _dialog.params = params;
    ...
    $.Dialog.open = function () {
        ...
        _overlay.fadeIn(function () {
            //$(this).fadeIn();
            
            _dialog
                .css("position", "fixed")
                .css("top", ($(window).height() - _dialog.outerHeight()) / 2)
                .css("left", ($(window).width() - _dialog.outerWidth()) / 2)
                .fadeIn();
        });

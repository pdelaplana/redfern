...
{
    public class UpdateCardTaskCommand : IRepositoryCommand<CardTask>
    {
        ...
        public CommandResult<CardTask> Execute(RedfernDb db)
        {
            ...
            activity.SetDescription("{actorlink} updated task {objectlink} in card {targetlink} in {contextlink}");
